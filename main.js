...
function student (first_name,last_name,birth_date) {
    ...
    this.birthday_greeting = () => {
        const nextBirthday = Math.abs (new Date().getMonth()-birth_date.getMonth())
...
let createStudent = () =>{
    ...
    const newStudent = new student (nameField.value,lastNameField.value,new Date (birthDateField.value))
